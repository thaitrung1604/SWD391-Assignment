...
public class MinuteOfHandoverController {
    ...
    @PutMapping("/{minuteOfHandoverId}")
    public MinuteOfHandoverDTO updateMinuteOfHandover(@PathVariable(value = "minuteOfHandoverId") long minuteOfHandoverId,
                                                      @Valid @RequestBody MinuteOfHandoverDTO minuteOfHandoverDTO) {
        return minuteOfHandoverService.update(minuteOfHandoverId, minuteOfHandoverDTO);
    }

    @DeleteMapping("/{minuteOfHandoverId}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteMinuteOfHandover(@PathVariable(value = "minuteOfHandoverId") long minuteOfHandoverId) {
        minuteOfHandoverService.delete(minuteOfHandoverId);
    }
}
